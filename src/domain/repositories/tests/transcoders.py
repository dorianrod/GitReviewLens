...
class MixinTranscoder:
    async def test_it_creates_transcoder(
        self, transcoder_repository, fixture_transcoder_dict
    ):
    ...
    async def test_it_updates_transcoder(
        self, transcoder_repository, fixture_transcoder_dict
    ):
        transcoder = Transcoder.from_dict(fixture_transcoder_dict)
        await transcoder_repository.create(transcoder)
    ...
    async def test_find_all_with_invalid_directory(self, transcoder_repository):
