...
class TestSummaryIndicators:
    def test_no_filters(self, dataset_1, fetch_all):
        query = """
...
class TestSummaryIndicatorsByDay:
    ...
    def test_only_smooth_over_period(self, dataset_1, fetch_all):
        query = """
        SELECT *
            FROM get_summary_statistics_by_day(
                '2 day',
...
class TestSankeyReviewers:
    def test_no_filters(self, dataset_1, pull_request_without_comment, fetch_all):
        query = """
            SELECT *
